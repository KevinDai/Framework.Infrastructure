...
namespace Framework.Infrastructure.Domain.Specification
{
         ...
         where T : class
    {
        ...
        /// <summary>
        /// <see cref="Framework.Infrastructure.Domain.Specification.ISpecification{T}"/>
        /// </summary>
        /// <returns><see cref="Framework.Infrastructure.Domain.Specification.ISpecification{T}"/></returns>
