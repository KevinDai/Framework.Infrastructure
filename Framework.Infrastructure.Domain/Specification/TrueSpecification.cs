...
namespace Framework.Infrastructure.Domain.Specification
{
        ...
        where TEntity:class
    {
        ...
        /// <summary>
        /// <see cref=" Framework.Infrastructure.Domain.Specification.Specification{TEntity}"/>
        /// </summary>
        /// <returns><see cref=" Framework.Infrastructure.Domain.Specification.Specification{TEntity}"/></returns>
