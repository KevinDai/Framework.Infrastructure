...
namespace Framework.Infrastructure.Domain.Specification
{
    /// <summary>
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="Framework.Infrastructure.Domain.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="Framework.Infrastructure.Domain.Specification.ISpecification{TEntity}"/></returns>
